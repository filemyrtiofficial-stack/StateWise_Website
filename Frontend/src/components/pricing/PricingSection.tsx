...
export const PricingSection: React.FC = () => {
  ...
  return (
    <section className="pb-12 md:pb-16 lg:pb-20 pt-0 bg-gray-50">
          ...
          <div className="bg-white rounded-xl shadow-lg p-5 sm:p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-base font-bold text-gray-900 mb-0.5">Quick Processing</h4>
                  <p className="text-xs sm:text-sm text-gray-600 leading-relaxed">
                    We process and file your RTI application within 1-2 business days, ensuring timely submission to the authorities.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-base font-bold text-gray-900 mb-0.5">Secure & Confidential</h4>
                  <p className="text-xs sm:text-sm text-gray-600 leading-relaxed">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-base font-bold text-gray-900 mb-0.5">First Appeal Support</h4>
                  <p className="text-xs sm:text-sm text-gray-600 leading-relaxed">
                    If your RTI is rejected, we help you file a compelling first appeal with expert drafting and legal guidance.
                  </p>
                </div>
              </div>
            </div>
