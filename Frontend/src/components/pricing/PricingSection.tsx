        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-5 mb-4">
          ...
          <div className="bg-white rounded-xl shadow-lg p-5 sm:p-6">
            ...
            <div className="space-y-2.5 mb-4">
              <div className="flex justify-between items-center py-1.5 border-b border-gray-200">
                ...
                <div className="flex gap-4 sm:gap-6">
                  <button
                    ...
                    className="text-xs sm:text-sm font-semibold text-gray-900 w-16 sm:w-20 text-center hover:text-blue-600 transition-colors cursor-pointer"
                  >
                    ₹399
                  </button>
                  <button
              ...
              <div className="flex justify-between items-center py-2 bg-gray-50 rounded-lg px-3">
                ...
                <div className="flex gap-4 sm:gap-6">
                  <button
                    onClick={() => handlePlanClick('basic')}
                    className="text-sm sm:text-base font-bold text-gray-900 w-16 sm:w-20 text-center hover:text-blue-600 transition-colors cursor-pointer"
                  >
                    ₹471
                  </button>
                  <button
            ...
            <button
              ...
              className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2.5 px-6 rounded-lg transition-all duration-200 shadow-md hover:shadow-lg text-sm"
            >
              Apply Now
            </button>
          </div>
        ...
        <div className="bg-gray-100 rounded-xl shadow-md p-5 sm:p-6 mt-6">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
              ...
              {' '}or email{' '}
              <a href="mailto:admin@filemyrti.com" className="text-blue-600 hover:text-blue-700 font-semibold underline">
                admin@filemyrti.com
              </a>
            </p>
          </div>
