        ...
        >
          ...
          >
            <div className="flex items-start gap-3 flex-1">
              <div className={`flex-shrink-0 w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold transition-colors ${openIndex === index
...
ServiceFAQAccordion.displayName = 'ServiceFAQAccordion';
  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col">
        ...
        {/* FILE: Frontend/src/pages/services/RTIModelPage.tsx - Navbar responsive: full width on mobile, offset on desktop */}
        {/* Navbar - Full width on mobile, offset by sidebar on desktop */}
        <div
        ...
        {/* FILE: Frontend/src/pages/services/RTIModelPage.tsx - Main content responsive layout */}
        <main
                ...
                <div className="max-w-7xl mx-auto px-3 md:px-6">
                  <div className="grid grid-cols-1 lg:grid-cols-4 gap-0">
                    ...
                    <div className="lg:col-span-4">
                      ...
                      {/* Mobile Sidebar - Appears below first section on small screens (below 768px) */}
                      {model && (
                        <div className="md:hidden bg-gradient-to-br from-primary-600 to-primary-800 text-white rounded-lg p-4 mb-6 transition-all duration-300">
                          {/* What Will You Get - Mobile (first) */}
                          <div className="mb-4">
        ...
        {/* Footer - Responsive: full width on mobile, offset on desktop */}
        {/* FILE: Frontend/src/pages/services/RTIModelPage.tsx - Footer responsive layout */}
        <div
          className="w-full"
          style={{
            marginLeft: 0,
