    ...
    <>
      ...
      <div className="min-h-screen flex flex-col">
        ...
        >
          ...
          <article className="container-responsive max-w-7xl mx-auto px-4 md:px-6 py-8" itemScope itemType="https://schema.org/Service">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-0">
                  ...
                  <div className="lg:col-span-4">
                    ...
                    <div className="rounded-lg shadow-lg border border-gray-200 p-8 mb-8">
                      ...
                      <div className="mb-6">
                        <h2 className="text-3xl font-bold text-gray-900 mb-2">Service Outline</h2>
                    ...
                    <div className="rounded-lg shadow-lg border border-gray-200 p-8 mb-8">
                      {/* Title with underline */}
                      <div className="mb-8">
                        <h2 className="text-3xl font-bold text-gray-900 mb-2">Why This Service?</h2>
                        <div className="h-1 bg-blue-600 w-48 rounded"></div>
                      </div>
                    ...
                    <div className="rounded-lg shadow-lg border border-gray-200 p-6 md:p-8 bg-white">
